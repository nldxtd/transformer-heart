        ...
        Task { @MainActor in
            ...
            for rowIndex in 0..<row {
                for colIndex in 0..<col {
                    matrix.vectorListWeight[rowIndex][colIndex] *= 2
                    withAnimation(.easeInOut(duration: 0.5)) {
                        connectProgress[rowIndex][colIndex] = 1.0
                        currentOutputValues[rowIndex] += vecWeight[colIndex] * firstMatrixWeight[rowIndex][colIndex]
                    }
                ...
                res.weight[rowIndex] *= 2
                matrix.vectorListWeight[rowIndex] = firstMatrixWeight[rowIndex]
