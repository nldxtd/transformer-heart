                    ...
                    HStack{
                            ...
                            HStack(spacing: 20) {
                                ...
                                VStack {
                                    Text("Token Embedding")
                                        ...
                                        .underline()
                                    VectorList(dimention: 10, vectors: embeddingMatrix, labels: embeddingMatrixWeight, color: .green, title: "")
                                }
                            }
                            ...
                            HStack(spacing: 20) {
                                ...
                                VStack {
                                    Text("Positional Encoding")
                                        ...
                                        .foregroundColor(.gray)
                                        .underline()
                                    VectorList(dimention: 10, vectors: embeddingMatrix, labels: embeddingMatrixWeight, color: .orange, title: "")
                                }
                            }
                        ...
                        if showComponents[2] {
                            HStack(spacing: 20) {
                                ...
                                VStack {
                                    Text(isMatrixMode ? "Final Embedding" : "Embedding Output")
                                        .font(.headline)
                                        .foregroundColor(.gray)
                                        .underline()
