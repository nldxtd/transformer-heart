    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("The probability P(y_i) of choosing token i is given by:")
                    .font(.subheadline)
                
                Text("P(yᵢ) = e^(zᵢ / T) / Σⱼ e^(zⱼ / T)")
                ...
                Text("Where:")
                    .font(.subheadline)
                Text("- zᵢ is the model's predicted logit for token i.")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("- T is the temperature hyperparameter.")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("- Lower T sharpens probabilities, making high-logit tokens more likely.")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                Text("- Higher T smooths probabilities, increasing randomness.")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
            }
            .padding()
